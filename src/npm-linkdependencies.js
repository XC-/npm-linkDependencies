...
if (require.main === module) {
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (settings.skipInEnvironments && settings.skipInEnvironments.length > 0) {
    if (settings.skipInEnvironments.indexOf(process.env[settings.environmentKey]) !== -1) {
      exitProcess.success("Detected an environment that should be skipped.");
    }
  }
